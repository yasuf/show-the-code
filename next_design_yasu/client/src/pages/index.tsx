    ...
    return (
      <div className="quadrant-bg bg-[#FFFFFF] w-full gap-4">
        <article className='col-start-2 col-span-2 text-pretty'>
          <h1 className='articleFont text-center font-[700] text-[40px] leading-[3.19rem] text-[#000000] pt-[57px]'>an</h1>
          <p className='articleFont font-[inter] text-[16px] text-center leading-[1.21rem] font-[300] text-[#646464] pt-[20px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the <br />industry's standard dummy text ever since the 1500s</p>
        </article>
