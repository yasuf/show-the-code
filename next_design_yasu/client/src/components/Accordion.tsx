...
interface AccordionItemProps {
    icon: 'Vector' | 'business' | 'code' | 'folder';
  }

const Acc: React.FC<AccordionItemProps> = ({icon}) => {
  ...
  const defaultContent =
    ...
    >
      <AccordionItem startContent={<Image src={vectoricon} alt={icon} width={26.3} height={22} className="mr-[20px]"  />} key="1" aria-label="Accordion 1" title="Documentation" className="font-[700] text-start text-[20px] accordionBorder">
